...
#line_item = Line_item.create(product_name: "snes",price: 129.99,quantity: 3, order_id: 5)
...
# console2 = Console.create(:product_type_id => 1, :name => "Sega Genesis", :price => 44.99, :date_released => Date.new(1988,10,28), :description => "Sega does what nintendon't oh oh shots fired!!!!")
